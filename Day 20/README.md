...
![XML-результат](https://github.com/AnzhelikaKravchuk/Training-Summer-Express-2018/blob/master/Pictures/XML.Task.png)
  ...
  Для тех URL-адресов, которые не совпадают с данным паттерном, “залогировать” информацию, отметив указанные строки, как необработанные. Для реализации в помощь https://msdn.microsoft.com/ru-ru/library/system.uri(v=vs.110).aspx 
